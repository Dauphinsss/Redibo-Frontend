    ...
    <div className="p-4 sm:p-6 max-w-3xl items-center justify-center">
      ...
      {roles.includes("HOST") && (
        <>
          ...
          >  
          <MessageCircle className="mx-auto mb-2 sm:mb-3 h-8 w-8 sm:h-10 sm:w-10" />
            <p className="text-base sm:text-lg font-semibold">Mis comentarios</p>
          </div>
      ...
      {roles.includes("RENTER") && (
        ...
        onClick={() => router.push("/Comentario/RenterRespuesta")}
        >
        <MessageCircle className="mx-auto mb-2 sm:mb-3 h-8 w-8 sm:h-10 sm:w-10" />
        <p className="text-base sm:text-lg font-semibold">Comentarios de propietarios</p>
        </div>
      )}
      </div>
    </div>
