...
export default function MisArrendatarios() {
  ...
  const [selectedPartner, setSelectedPartner] = useState<Arrendatario | null>(
    null
  );
  ...
  useEffect(() => {
    ...
    if (!roles.includes("DRIVER")) {
      setError(
        "Acceso denegado. Solo los usuarios con rol DRIVER pueden ver esta sección."
      );
      setLoading(false);
      return;
    }
    ...
    const fetchArrendatarios = async () => {
      ...
      try {
        ...
        const sortedArrendatarios = res.data.partners
          ? [...res.data.partners].sort((a: Arrendatario, b: Arrendatario) =>
          ...
          <div className="max-w-2xl mx-auto p-4">
            ...
            {loading ? (
              ...
              <div className="text-center text-gray-500 py-8">
                Aún no tienes arrendatarios asociados. <br />{" "}
