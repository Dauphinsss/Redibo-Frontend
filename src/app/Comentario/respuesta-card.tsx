...
interface RespuestaRenter {
  ...
  comentario: string
  fecha_creacion: string
  calificacion_puntuacion: number
  reserva: {
    id: number
    Usuario: {
      id: number
...
export function RespuestaCard({ respuesta, onUpdateAction }: RespuestaCardProps) {
 ...
 const tieneRespuestas = Array.isArray(respuesta.comentariosRespuesta) && respuesta.comentariosRespuesta.length > 0;
  ...
  const botonHabilitado =  nuevaRespuesta.trim().length > 0 &&
  !enviando &&
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        <div className="flex items-center gap-2 mb-2">
          <Avatar className="w-6 h-6">
            <AvatarFallback className="text-xs bg-blue-500 text-white">H</AvatarFallback>
          </Avatar>
        ...
        <p className="text-sm text-gray-700 mb-2">{respuestaHost.comentario}</p>
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1">{renderStars(respuesta.calificacion_puntuacion)}</div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-gray-700">Comentario del Host </span>
          </div>
            ...
            {respuesta.comentariosRespuesta!.map((respuestaHost) => (
              <div key={respuestaHost.id}>
                ...
                <div className="bg-blue-50 p-3 rounded shadow-sm ml-2">
                  <p className="text-sm text-gray-300">{respuestaHost.comentario}</p>
