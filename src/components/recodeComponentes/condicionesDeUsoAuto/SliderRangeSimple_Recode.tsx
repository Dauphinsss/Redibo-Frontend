...
function SliderRangeSimple_Recode({
    ...
    // Maneja el cambio y dispara onChange externo
    ...
    return (
        <div className="flex flex-col items-center rounded-xl  w-full max-w-md">
                    ...
                    <Range
                        ...
                        renderThumb={({ props }) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-black text-white text-sm px-2 py-1 rounded inline-flex items-center space-x-1">
                                        <span>{value[0]}</span>
