...
export default function CarCardPrice({ precioOficial, precioDescuento, precioPorDia, id }: Props) {
    return (
        ...
        <div>
            <p className="text-xl font-bold">Bs. {precioOficial}</p>
            <p className="text-gray-400 line-through">Bs. {precioDescuento}</p>
            <p className="text-sm text-gray-600">Por día: Bs. {precioPorDia}</p>
        </div>
